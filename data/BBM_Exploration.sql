...
-- Legacy point cards
--========================================================================================================================
-- Cultural 2x card: 4 culture and 4 happiness (from 1-1) on world wonders
UPDATE ModifierArguments
SET Value = 4
WHERE ModifierId = 'CARD_AT_EXP_VICTORY_CULTURAL_WONDER_CULTURE' AND Name = 'Amount';

UPDATE ModifierArguments
SET Value = 4
WHERE ModifierId = 'CARD_AT_EXP_VICTORY_CULTURAL_WONDER_HAPPINESS' AND Name = 'Amount';
--========================================================================================================================
--========================================================================================================================
